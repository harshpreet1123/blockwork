...
const ExcangeCard = ({ crypto }) => {
  ...
  return (
    <div className="exchange-card bg-white hover:bg-slate-100 cursor-pointer rounded-lg shadow-lg p-6 hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">
