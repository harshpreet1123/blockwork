const Footer = () => {
  return (
    <div className="">
      <footer className="w-full h-full backdrop-blur-lg bg-gradient-to-tr from-blue-950/80 to-purple-950/80  text-white p-5 flex flex-col md:flex-row md:scroll-px-12 flex-wrap justify-between">
        ...
        <div>
          ...
          <div>
            ...
            <p className="text-xl font-semibold">oukgubcbq9yr</p>
            <p className="text-xl font-semibold">oujb3i</p>
            <p className="text-xl font-semibold">ojbkpouv</p>
          </div>
        </div>
        <div>
