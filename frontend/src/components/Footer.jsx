const Footer = () => {
  return (
    <div className="">
      <footer className="w-full h-full bg-gradient-to-tr from-blue-800 to-purple-700  text-white p-5 flex flex-col md:flex-row md:scroll-px-12 flex-wrap justify-between">
