    ...
    <div className=" w-full ">
      ...
      <div className="flex items-center justify-center align-middle text-center justify-items-center h-screen">
        <div className="container p-52 mb-48">
          <div className="flex-1 bg-gradient-to-br  -my-2 from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 border-solid border-2 h-40 border-purple-400 rounded-xl">
