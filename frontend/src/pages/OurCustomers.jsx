  ...
  return (
    ...
    <div className="h-auto w-100 flex flex-wrap flex-col items-center text-center p-10 m-1">
        <div className="w-full h-auto flex flex-wrap flex-col items-center text-center">
            <p className="text-black font-bold text-3xl md:text-4xl text-center">Pure Hardwork, No Shortcuts</p>
            <div className="w-36 h-1 border-b-4 border-yellow-400 mt-2 rounded-2xl md:mt-4 mb-2"></div>
        </div>
        <div className="w-full h-auto flex flex-wrap justify-evenly">
            <div className="w-46 flex flex-col items-center mb-12">
                ...
                <p className="text-3xl font-bold text-black mt-1 mb-2">600+</p>
                <p className="text-3xl font-bold text-gray-800 mb-1"> Jobs </p>
            </div>
            <div className="w-46 flex flex-col items-center mb-12">
                <Lottie className="w-48 h-48 mt-3" animationData={Client} />
                <p className="text-3xl font-bold text-black mt-1 mb-2">700,000+</p>
                <p className="text-3xl font-bold text-gray-800 mb-1">Clients</p>
            </div>
            <div className="w-46 flex flex-col items-center mb-12">
                <Lottie className="w-48 h-48 mt-3" animationData={Freelancer} />
                <p className="text-3xl font-bold text-black mt-1 mb-2">10000+</p>
                <p className="text-3xl font-bold text-gray-800 mb-1">Freelancers</p>
            </div>
            <div className="w-46 flex flex-col items-center mb-12">
            <Lottie className="w-48 h-48 mt-3" animationData={Transaction} />
                <p className="text-3xl font-bold text-black mt-1 mb-2">10000+</p>
                <p className="text-3xl font-bold text-gray-800 mb-1">Successfull Transactions</p>
            </div>
        </div>
    </div>
    </div>
